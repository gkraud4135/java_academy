...
public class Car {
	...
	int maxSpeed = 200;
	int speed;
	//생성자 클래스가 public이면 자동으로 컴파일러 생성자가 있으면 기본생성자가x> 별도로 정의해줘야함
	public Car(){}
	...
	//메서드
	void str(){System.out.println(this.company+","+this.model);};
	public static int str1(int a, int b){return a+b;};
	public void powerOn(){
		System.out.println("시동On");
	}
	void powerOn(String owner){
		System.out.println(owner+"차량 시동On");
	}
